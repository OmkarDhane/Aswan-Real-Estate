      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-4 gap-6 text-gray-800 mb-10">
          <div className="flex flex-col">
            <span className="font-semibold text-2xl">Rent:</span> 
    ...
    <div className="w-[450px] bg-white p-6 rounded-lg shadow-lg">
      ...
      >
        ...
        <textarea
          ...
          placeholder="Message"
          required
          className="w-full border px-4 py-2 h-32 rounded"
        ></textarea>

        <button
          type="submit"
          className="w-full bg-red-600 text-white py-2 rounded hover:bg-red-700 duration-200"
        >
          Send Message
        </button>
      </form>
