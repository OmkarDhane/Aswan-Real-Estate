...
const PropertyInfoRent = () => {
  ...
  const fetchProperty = async () => {
    try {
      const res = await fetch(`http://localhost:3000/api/properties/rent/${id}`);
  ...
  if (!property) return <div className="py-20 text-center">Not Found</div>;
  ...
  return (
    <div className="bg-[#f5f6f1] font-[Poppins]">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-8">

        {/* Breadcrumb */}
        <div className="text-sm text-gray-500 mb-4">
          <Link to="/" className="hover:text-red-600">Home</Link> &gt;
          <Link to="/for-rent" className="mx-1 hover:text-red-600">For Rent</Link>
