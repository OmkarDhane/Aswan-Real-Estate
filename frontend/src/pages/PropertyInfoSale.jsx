    ...
    <div className="min-h-screen bg-[#f5f6f1] font-[Poppins]">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-10 border-b border-gray-200 pb-8">
          <div><p className="font-bold text-gray-800 uppercase text-xs">Price</p><p className="text-red-600 font-bold text-xl">AED {property.price?.toLocaleString()}</p></div>
        ...
        {/* 🔹 Updated Google Map Section (Using googleMapLink) 🔹 */}
          ...
          <div className="mb-10 border-t pt-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {similarProperties.map((p) => (
                <Link key={p.documentId} to={`/property-info-sale/${p.documentId}`} className="bg-white shadow-sm hover:shadow-md transition-all overflow-hidden border border-gray-100">
