...
export interface ApiInquiryInquiry extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    property: Schema.Attribute.Relation<'oneToOne', 'api::article.article'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPropertyProperty extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    amenties: Schema.Attribute.String & Schema.Attribute.DefaultTo<'\u2714'>;
    area: Schema.Attribute.String;
    beds: Schema.Attribute.Integer;
    category: Schema.Attribute.Enumeration<['option:', 'sale', 'rent']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    stats: Schema.Attribute.Enumeration<['option:', 'available', 'sold']>;
    title: Schema.Attribute.String;
